namespace Zebble
{
    ...
    public partial class DatePicker : Picker, FormField.IPlaceHolderControl, FormField.IControl
    {
        // Formatting
        ...
        {
            get => selectedValue;
            set { selectedValue = value; SelectedText = selectedValue.ToString(TextFormat); }
        }
